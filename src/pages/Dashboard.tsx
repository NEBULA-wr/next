  ...
  return (
    <div className="flex xl:flex-row flex-col gap-6">
      ...
      <div className="flex-1 space-y-8 max-w-5xl">
        ...
        {/* Hero */}
        <div className="relative">
          <div className="relative z-10 lg:w-[60%] xl:w-2/3">
            <p className="text-sm font-semibold tracking-wider text-brand-primary uppercase mb-2">Bienvenido a SchoolTasker</p>
            <h1 className="text-3xl sm:text-4xl lg:text-3xl xl:text-4xl font-bold text-gray-900 tracking-tight leading-[1.15] mb-4">
              Conectamos estudiantes <br className="hidden sm:block" /> con <span className="text-brand-primary">soluciones rápidas</span>
            </h1>
            <p className="text-gray-600 max-w-md xl:max-w-lg text-sm sm:text-base mb-8 leading-relaxed">
              Plataforma de conexión académica. Encuentra ayuda para tus maquetas, resúmenes o proyectos, o gana dinero ayudando a otros.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 mb-2 max-w-xl">
              <button 
                onClick={() => navigate('/explorer')}
                className="flex-1 bg-brand-sidebar hover:bg-[#1a1e36] text-white rounded-2xl p-5 text-left transition-all group shadow-sm flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <div className="bg-white/10 p-2 rounded-full"><Search className="w-4 h-4" /></div>
                    <span className="text-[10px] font-bold tracking-wider text-gray-300">QUIERO TRABAJAR</span>
                  </div>
                  <h3 className="text-lg font-bold mb-1">Buscar tareas</h3>
                  <p className="text-xs text-gray-400">Explora trabajos escolares que puedes realizar por un pago.</p>
                </div>
              ...
              <button 
                ...
                className="flex-1 bg-white hover:bg-gray-50 border border-gray-200 text-gray-900 rounded-2xl p-5 text-left transition-all group shadow-sm flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <div className="bg-brand-primary/10 p-2 rounded-full"><Plus className="w-4 h-4 text-brand-primary" /></div>
                    <span className="text-[10px] font-bold tracking-wider text-brand-primary">NECESITO AYUDA</span>
                  </div>
                  <h3 className="text-lg font-bold mb-1">Publicar tarea</h3>
                  <p className="text-xs text-gray-500">Sube lo que necesitas y un compañero lo hará por ti.</p>
                </div>
                <div className="mt-4 flex justify-end">
          ...
          <div className="hidden lg:block absolute right-0 top-0 lg:-translate-y-4 xl:translate-y-0 lg:translate-x-4 xl:translate-x-0">
            ...
            <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=600&q=80" alt="Students studying" className="w-[280px] h-[280px] xl:w-72 xl:h-72 object-cover rounded-[2rem] shadow-xl mask-image-circle z-0 border-8 border-white object-top" style={{ clipPath: 'circle(50% at 50% 50%)' }} />
          </div>
        </div>
