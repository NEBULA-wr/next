      ...
      <div className="flex xl:flex-row flex-col gap-6">
        ...
        <div className="flex-1 space-y-8 max-w-5xl">
          ...
          <div className="relative flex flex-col xl:flex-row gap-8 items-center xl:items-start justify-between">
            <div className="flex-1 w-full xl:max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-2">
                <button 
                  ...
                  className="flex-1 bg-brand-sidebar hover:bg-[#1a1e36] text-white rounded-2xl p-5 text-left transition-all group shadow-sm flex flex-col items-start justify-between min-h-[140px]"
                >
                ...
                <button 
                  ...
                  className="flex-1 bg-white hover:bg-gray-50 border border-gray-200 text-gray-900 rounded-2xl p-5 text-left transition-all group shadow-sm flex flex-col items-start justify-between min-h-[140px]"
                >
                  <div className="w-full">
                    <div className="flex items-center justify-between gap-3 mb-2 w-full">
            ...
            <div className="hidden lg:block relative flex-shrink-0 items-center justify-center">
              ...
              <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=600&q=80" alt="Students studying" className="w-56 h-56 xl:w-72 xl:h-72 object-cover rounded-full shadow-lg border-8 border-white object-top" />
            </div>
          </div>
